...
```{r}
scatterplotMatrix( ~ pg +sp , data=Data.Q1, diagonal=list(method="boxplot" ) ,
regLine = list(method=lm, lty=1,
lwd=2,col="red"), smooth=list(smoother=loessLine, spread=TRUE,
...
data1$year <- as.numeric(data$year)
y<-split(data, cut(data$year, c(1961, 1970, 1980, 1990,2000,2010), include.lowest=TRUE))
```
...
data1$decades=cut(data$year, c(1961, 1970, 1980, 1990, 2000, 2010), include.lowest = TRUE)
data1$decades <- as.numeric(data$class)
data1$decades=cut(data$year, c(1961, 1970, 1980, 1990, 2000, 2010), include.lowest = TRUE)
data1$decades <- as.numeric(data$class)
head(data1)
```
...
```{r}
pairs(
decades~., data=data1[,2:3], col=data1$decades)
```
